...
internal class SharpCompressExample
{
    internal static void Run()
    {
...

        {
            ...
            var writerOptions = new WriterOptions(CompressionType.GZip) { LeaveStreamOpen = true, };
        ...
        // --
        {
            ...
            var decompressedContainerNameFromFileName = Path.GetFileNameWithoutExtension(
                compressedFile
            );
            ...
            {
                decompressedContainerNameFromFileName = Path.GetFileNameWithoutExtension(
                    decompressedContainerNameFromFileName
                );
            }
