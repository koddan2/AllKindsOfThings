...
namespace N3.Model
{
	...
	public readonly record struct SvenskaKronor([property: DataMember]decimal Belopp) : IPengar
	{
		...
		[JsonIgnore]
		public SvenskaKronor AvrundaHelaKronor => Math.Round(Belopp, 0, MidpointRounding.AwayFromZero);
		[JsonIgnore]
		public SvenskaKronor AvrundaHelaKronorOchÖren => Math.Round(Belopp, 2, MidpointRounding.AwayFromZero);
